    ...
    >
      ...
      <div className="absolute inset-0">
        <Media
          ...
          sizes="100vw"
          /*
           * Пара стоит в правой половине кадра. На телефоне из 1600px
           * исходника видно 665 — при центрированной обрезке в кадр не
           * попадает никто, поэтому окно уезжает вправо. На широком экране
           * кадр показывается во всю ширину и режется уже по вертикали:
           * головы лежат на y≈90 из 821, и центрированная обрезка срезала
           * бы их — отсюда 28% сверху.
           */
          imageClassName="object-[78%_center] lg:object-[50%_28%]"
