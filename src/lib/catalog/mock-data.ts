...
export const categories: Category[] = [
  ...
  {
    id: "cat-tur",
    // Слаг оставлен прежним намеренно: это внутренний идентификатор, на
    // него не ссылается ни один товар, а смена слага сломала бы адрес
    // /catalog/tur без единой выгоды для посетителя. Название раздела
    // видит клиент, слаг — только код.
    slug: "tur",
    title: "Свадебные образы",
    titleTg: "Образҳои тӯёна",
    titleEn: "Wedding looks",
    order: 6,
  },
  {
    id: "cat-tuy",
