...
export const categories: Category[] = [
  {
    ...
    title: "Платья",
    titleTg: "Либос",
    description: "Свадебные и церемониальные платья коллекции.",
    image: photo("cat-libos", "Образ из коллекции ARUS DOMOD"),
    order: 1,
  },
  {
    id: "cat-arus",
    ...
    title: "Для невесты",
    titleTg: "Барои арӯс",
    description: "Полные образы невесты — от платья до головного убора.",
  ...
  },
  {
    ...
    title: "Для жениха",
    titleTg: "Барои домод",
    description: "Образы жениха и парные выходы.",
  ...
  },
  {
    ...
    title: "Аксессуары",
    titleTg: "Лавозимот",
    description: "Головные уборы и дополнения к образу.",
...
const seeds: LookSeed[] = [
  { n: 1,  category: "arus",      frames: 2, purchase: 890000, rental: [180000, 3], sizes: ["38", "40", "42"], availability: "in_stock" },
  { n: 2,  category: "libos",     frames: 2, purchase: 620000, rental: [130000, 3], sizes: ["38", "40", "42", "44"], availability: "in_stock" },
  { n: 3,  category: "libos",     frames: 2, purchase: 740000, compareAt: 920000, sizes: ["40", "42"], availability: "in_stock" },
  { n: 4,  category: "libos",     frames: 2, purchase: 960000, rental: [210000, 3], sizes: ["38", "40", "42"], availability: "made_to_order" },
  { n: 5,  category: "libos",     frames: 2, purchase: 540000, rental: [115000, 3], sizes: ["36", "38", "40"], availability: "in_stock" },
  { n: 6,  category: "libos",     frames: 2, purchase: 680000, sizes: ["38", "40", "42", "44"], availability: "in_stock" },
  { n: 7,  category: "domod",     frames: 2, purchase: 470000, rental: [95000, 3], sizes: ["48", "50", "52"], availability: "in_stock" },
  { n: 8,  category: "domod",     frames: 2, purchase: 520000, rental: [110000, 3], sizes: ["48", "50", "52", "54"], availability: "in_stock" },
  { n: 9,  category: "tuy",       frames: 2, rental: [240000, 3], availability: "rental_only" },
  { n: 10, category: "tuy",       frames: 2, rental: [225000, 3], availability: "rental_only" },
  { n: 11, category: "libos",     frames: 2, purchase: 830000, rental: [170000, 3], sizes: ["38", "40", "42"], availability: "in_stock" },
  { n: 12, category: "libos",     frames: 2, purchase: 910000, compareAt: 1120000, sizes: ["38", "40"], availability: "in_stock" },
  { n: 13, category: "tuy",       frames: 2, purchase: 390000, rental: [85000, 3], sizes: ["40", "42", "44"], availability: "in_stock" },
  { n: 14, category: "libos",     frames: 2, purchase: 720000, rental: [150000, 3], sizes: ["38", "40", "42"], availability: "in_stock" },
  { n: 15, category: "libos",     frames: 2, purchase: 660000, sizes: ["38", "40", "42", "44"], availability: "in_stock" },
  { n: 16, category: "libos",     frames: 2, purchase: 780000, rental: [165000, 3], sizes: ["38", "40", "42"], availability: "made_to_order" },
  { n: 17, category: "lavozimot", frames: 2, purchase: 165000, rental: [40000, 2], availability: "in_stock" },
  { n: 18, category: "zewar",     frames: 1, purchase: 340000, rental: [70000, 2], availability: "in_stock" },
  { n: 19, category: "arus",      frames: 2, purchase: 880000, rental: [185000, 3], sizes: ["38", "40", "42"], availability: "in_stock" },
  { n: 20, category: "arus",      frames: 2, purchase: 850000, compareAt: 990000, sizes: ["40", "42"], availability: "sold_out" },
  { n: 21, category: "lavozimot", frames: 1, purchase: 145000, availability: "in_stock" },
];
